...
class GpsFinder:
    ...
    def remove_job_type_data(self) -> pd.DataFrame:
        ...
        """
        self.data_jobs['job_location']=self.data_jobs['job_location'].apply(self._remove_text_in_parentheses) 
    ...
    def process_job_locations(self) -> pd.DataFrame:
        ...
        self.data_jobs['coordinates'] = self.data_jobs['job_location'].apply(self.get_gps_coordinates)
        self.data_jobs[['latitude', 'longitude']] = pd.DataFrame(self.data_jobs['coordinates'].tolist(), index=self.data_jobs.index)
